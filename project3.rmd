...
c<- confusionMatrix(data = diabetes.test.log$Diabetes_binary, reference = predict(fit.lmt, newdata = diabetes.test.log))
...
```  
```{r}
#postResample(predict(fit.log3, newdata = diabetes.test.log, type = "prob"), obs = diabetes.test.log)
#a<- confusionMatrix(data = diabetes.test.log$Diabetes_binary, reference = predict(fit.log3, newdata = diabetes.test.log, type = "prob"))
mnLogLoss(diabetes.test.log, lev = diabetes.test.log$Diabetes_binary, model = fit.log3)
