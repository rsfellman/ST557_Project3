...
## Lasso  
Lasso regression is an extension of linear regression. It uses the the glmnet package.  
```{r}
...
A classification tree is used to predict what class each region is using the most prevalent class as as the prediction. 
```{r}
