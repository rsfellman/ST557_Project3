...
![](Education_level5_files/figure-gfm/unnamed-chunk-4-1.png)<!-- --> In
...
```
    ...
    ##   No Diabetes                          55846                      3710
    ##   Pre-/Diabetes                        10096                       258
...
![](Education_level5_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
```
    ...
    ##                
    ##                  Not Avoid  Avoid Doc
    ##   No Diabetes   0.76941782 0.08247747
    ##   Pre-/Diabetes 0.13121156 0.01689315
...
![](Education_level5_files/figure-gfm/unnamed-chunk-8-1.png)<!-- --> In
...
![](Education_level5_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](Education_level5_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](Education_level5_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
```
    ...
    ## No pre-processing
    ## Resampling: Cross-Validated (5 fold) 
    ## Summary of sample sizes: 15660, 15660, 15660, 15660, 15660 
    ## Resampling results across tuning parameters:
    ## 
    ##   mtry  logLoss 
    ##   2     1.912001
...
```
    ...
    ## [1] "The best partial least squares model is ncomp= 6  "
