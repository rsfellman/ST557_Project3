...
![](Education_level1_files/figure-gfm/unnamed-chunk-4-1.png)<!-- --> In
...
![](Education_level1_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](Education_level1_files/figure-gfm/unnamed-chunk-8-1.png)<!-- --> In
...
![](Education_level1_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](Education_level1_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
![](Education_level1_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
```
    ...
    ## [1] "The best classification tree model is cp= 0.009  "
...
```
    ...
    ## No pre-processing
    ## Resampling: Cross-Validated (5 fold) 
    ## Summary of sample sizes: 945, 944, 943, 945, 943 
    ## Resampling results across tuning parameters:
    ## 
    ##   mtry  logLoss  
    ##   2     0.8464738
